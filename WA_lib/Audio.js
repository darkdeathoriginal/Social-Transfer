const {
  ...
  class Audio extends Base {
    ...
    _patch(data) {
      ...
      this.caption =
        data.message.audioMessage.caption === null
          ? data.message.audioMessage.caption
          : "";
  
      this.url = data.message.audioMessage.url;
      ...
      this.mimetype = data.message.audioMessage.mimetype;
  
      this.height = data.message.audioMessage.height;
  
      this.width = data.message.audioMessage.width;
  
      this.mediaKey = data.message.audioMessage.mediaKey;
  
      this.data = data;
  
      if (
        data.message.audioMessage.hasOwnProperty("contextInfo") &&
